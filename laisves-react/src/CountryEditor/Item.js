...
class Item extends Component {
    ...
    deleteHandler = (event) => {
        this.props.deleteHandler(this.props.item.name)
    }
        ...
        return (
            <div className="card float-left" style={{width: '200px', height:'250px', margin: '10px'}}>
                ...
                <div className="card-body">
                    ...
                    <h6 className="card-text"><span className="badge badge-secondary">{this.props.item.president}</span></h6>
                    <h6 className="card-text">ISBN: {this.props.item.image}</h6>
                </div>
